...
router.post(
  ...
  withTiming(async (request) => {
    try {
      ...
      const rows = [];
      const imageRefs = {};
      const truncateText = /* @__PURE__ */ __name((text, maxLength = 32700) => {
        if (!text) return "";
      ...
      const worksheet = utils.aoa_to_sheet([headers, ...finalRows]);
...
// .wrangler/tmp/bundle-SLcJ08/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-SLcJ08/middleware-loader.entry.ts
