...
router.post(
  ...
  withTiming(async (request) => {
    ...
    if (!body || !Array.isArray(body.rows) || body.rows.length === 0) {
      return jsonError("rows array is required", 422);
    }
    const headers = [
      "Word",
      "Arabic Translation",
...
// .wrangler/tmp/bundle-BCzJtb/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-BCzJtb/middleware-loader.entry.ts
