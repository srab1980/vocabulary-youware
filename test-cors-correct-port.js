// Test CORS from the correct frontend origin
async function testFrontendCORSCorrectPort() {
  try {
    console.log("Testing CORS from correct frontend origin (http://127.0.0.1:5179)...");
