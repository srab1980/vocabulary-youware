// Test script to verify character limit fix
console.log("=== Testing Character Limit Fix ===");
...
async function testCharacterLimit() {
  try {
    ...
    console.log("2. Testing export with text exceeding Excel limit...");
    ...
    if (exportResponse.ok) {
      ...
      console.log(`   ✅ Character limit fix is working - long text was truncated`);
    } else {
